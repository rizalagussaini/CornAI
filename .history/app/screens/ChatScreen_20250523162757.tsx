...
export default function ChatScreen() {
  ...
  const [messages, setMessages] = useState([
    { message: 'Halo! 🌽 Saya CornAI. Silakan pilih salah satu opsi:', isUser: false },
    { message: '📊 Analisis Data Tanaman', isUser: false },
    { message: '🤖 Dapatkan Rekomendasi Berbasis AI', isUser: false },
    { message: '🌤️ Cek Prakiraan Cuaca', isUser: false },
  ]);
